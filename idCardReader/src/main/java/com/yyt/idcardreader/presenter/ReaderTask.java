...
import com.yyt.idcardreader.model.AppendLogEvent;
import com.yyt.idcardreader.model.DeviceParamBean;
import com.yyt.idcardreader.model.ReportCardRemovedEvent;
import com.yyt.idcardreader.model.ReportReadACardEvent;
import com.yyt.idcardreader.model.ReportReadIDCardEvent;
import com.yyt.idcardreader.model.ReportReadcardThreadExitEvent;
import com.yyt.idcardreader.model.ReportStartReadcardResultEvent;
...
public class ReaderTask {
	...
	private class ReaderAsyncHandler extends Handler {
		...
		private boolean isNetworkReader(String productName) {
			return (productName != null && (productName.contains("iDR212") || productName.contains("iDR213")
					|| productName.contains("W211") || productName.equals("STM32 DFU")));
		}
		...
		private void processInit(Message msg) {
			...
			case MSG_USB_DEV_ATTACHED: {
				...
				boolean isNetReader = isNetworkReader(waitingDevice.getProductName());
				// 1. 打开读卡器
